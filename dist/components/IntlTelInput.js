  ...
  _createClass(IntlTelInput, [{
    ...
    value: function render() {
      ...
      if (this.props.renderComponent) {
        return this.props.renderComponent(wrapperProps, flagDropDownProps, inputProps);
      }

      return _react.default.createElement("div", wrapperProps, _react.default.createElement(_FlagDropDown.default, flagDropDownProps), _react.default.createElement(_TelInput.default, {
